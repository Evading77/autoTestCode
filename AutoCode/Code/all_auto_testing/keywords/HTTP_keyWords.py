...
from frameworkutils import logger, Encrypt, config
...
class HTTP:
    ...
    def __init__(self, writer):
        ...
        # 设置请求默认的头
        self.session.headers["content-type"] =config.config['content_type']
        self.session.headers['user-agent'] =config.config['user_agent']
        # 项目接口基本地址
        self.url = ""
        # 保存请求结果
        self.result = None
